...
export default function CashForCarsRedDeerPage() {
  return (
    <div className="bg-white text-slate-900">
      <CityPageJsonLd
        city="Red Deer"
        title="Cash for Cars in Red Deer - Fast Offers, Free Pickup, Real Payment"
        description="Maple Cash for Cars makes selling a vehicle in Red Deer simple with same-day offers, free towing, and cash on pickup."
        faqs={faqs}
      />
